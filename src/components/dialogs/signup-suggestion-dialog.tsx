    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Your link has been shortened and is ready to use. Want to save and track this link?</DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2">
          <Button variant={"outline"} className="sm:w-auto w-full" onClick={() => onOpenChange(false)}>
            Maybe Later
          </Button>
          <Button variant={"outline"} className="sm:w-auto w-full" onClick={() => handleSignin}>
            Log In
          </Button>
