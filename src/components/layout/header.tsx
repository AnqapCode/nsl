            ...
            <SheetContent side="right" className="w-[250px] sm:w-[300px]">
              ...
              <nav className="flex flex-col gap-4 mt-6">
                ...
                {isAuthenticated ? (
                  <>
                    <Button variant={"ghost"} size={"sm"} asChild>
                      <Link href={"/dashboard"} className="flex items-center gap-2 justify-start w-full">
                        <LayoutDashboard className="size-4" />
                        Dashboard
                      </Link>
                    </Button>
                    ...
                    <Button variant={"ghost"} size={"sm"} asChild>
                      <Link href={"/dashboard/stats"} className="flex items-center gap-2 justify-start w-full">
                        <LayoutDashboard className="size-4" />
                        My Stats
                      </Link>
                    </Button>
                  ...
                  <>
                    ...
                    <Button variant={"ghost"} size={"sm"} asChild>
                      <Link href={"/register"} className="flex items-center gap-2 justify-start w-full">
                        <UserPlus className="size-4" />
                        Register
                      </Link>
                    </Button>
