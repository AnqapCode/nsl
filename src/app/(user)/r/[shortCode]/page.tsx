...
export const metadata: Metadata = {
  title: "Redirecting...",
  description: "You are being redirecting to the original URL",
};
      ...
      return (
        <div className="flex h-[calc(100vh-64px)] items-center justify-center px-4">
          <div className="w-full max-w-md mx-auto text-center">
            ...
            <h1 className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mb-4">Caution: Flagged URL</h1>
            <p className="text-muted-foreground mb-2">This link has been flagged by our safety system and is pending review by an administrator.</p>

            {response.data.flagReason && <p className="text-sm text-yellow-600 dark:text-yellow-400 mb-6 bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-md">Reason: {response.data.flagReason}</p>}
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] items-center justify-center px-4">
      <div className="w-full max-w-md mx-auto text-center">
        ...
        <p className="text-muted-foreground mb-6">The short link you&apos;re trying to access does&apos;nt exist or has been removed</p>
